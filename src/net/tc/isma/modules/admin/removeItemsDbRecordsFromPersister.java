...
public class removeItemsDbRecordsFromPersister extends actionImpl
{
	public removeItemsDbRecordsFromPersister()
	{
	}
	...
	public Results execute()
	{
		...
		try
		{
			areas = ( Map ) IsmaPersister.get( HashMap.class, "items.all.records" );
		}
		catch( Exception ex )
		{
