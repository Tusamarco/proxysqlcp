...
public class removeElementsDbRecordsFromPersister extends actionImpl
{
	public removeElementsDbRecordsFromPersister()
	{
	}
	...
	public Results execute()
	{
		...
		try
		{
			areas = ( Map ) IsmaPersister.get( HashMap.class, "elements.all.records" );
		}
		catch( Exception ex )
		{
