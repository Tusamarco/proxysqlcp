...
import com.mysql.cluster.mgmj.events.Disconnected;
 ...
 * @version 1.0
 */
public class DisconnectListener extends DisconnectedTypeListener {
    ...
    public void handleEvent(Disconnected event) {
         IsmaPersister.getLogByName("NDBMGMLISTENER").info(TimeTools.GetCurrentTime() + " - Disconnected node:" +
                           event.getNode());
        ...
        try {
            ...
            node.setStatus(NodeStatus.NDB_MGM_NODE_STATUS_NO_CONTACT.toString());
            ...
            System.out.println("aaaa modified dis " + node.getId());
        ...
        eventL.setCurrentvalue(NodeStatus.NDB_MGM_NODE_STATUS_NO_CONTACT.toString());
